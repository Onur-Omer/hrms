...
public class AJSKPSPublicSoap
{
    ...
    public AJSKPSPublicSoap(){}

    public AJSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AJSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AJSExtendedSoapSerializationEnvelope envelope= new AJSExtendedSoapSerializationEnvelope(AJSExtendedSoapSerializationEnvelope.VER11);
