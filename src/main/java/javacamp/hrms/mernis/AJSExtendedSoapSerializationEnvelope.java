...
public class AJSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AJSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AJSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AJSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AJSDateTimeConverter dateTimeConverter = new AJSStandardDateTimeConverter();

    public AJSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AJSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AJSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AJSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AJSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AJSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
